# Graph Report - hotogram.app  (2026-08-02)

## Corpus Check
- 139 files · ~74,178 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 719 nodes · 1453 edges · 86 communities (37 shown, 49 thin omitted)
...
- `Props` --references--> `Restaurant`  [EXTRACTED]
  src/components/billing/PaymentTransactionsPanel.tsx → src/types/database.ts
...
Cohesion: 0.11
Nodes (46): DashboardLayout(), DashboardLayoutProps, Logo(), LogoProps, Badge(), BadgeProps, badgeVariants, Button (+38 more)
...
Cohesion: 0.07
Nodes (35): CustomerHelpButton(), CustomerIdentityDialog(), CustomerRequestButtons(), CustomerRequestButtonsProps, DishDetailDialog(), DishDetailDialogProps, getImageUrl(), OrderTrackerDrawerProps (+27 more)

### Community 4 - "database.ts"
Cohesion: 0.06
Nodes (60): PaymentTransactionsPanel(), Props, statusColors, CustomerHelpButtonProps, CustomerIdentityDialogProps, customerSchema, HotogramLoader(), HotogramLoaderProps (+52 more)
...
Cohesion: 0.07
Nodes (41): RequirePlatformAdmin(), useToast(), useAuth(), ExtractedCategory, ExtractedItem, extractMenuFromImage(), createErrorToast(), ERROR_CODE_MAP (+33 more)
...
Cohesion: 0.15
Nodes (13): framer-motion, dependencies, framer-motion, @radix-ui/react-aspect-ratio, @radix-ui/react-tabs, @radix-ui/react-toast, @radix-ui/react-tooltip, recharts (+5 more)
...
Cohesion: 0.11
Nodes (23): Notification, NotificationBell(), NotificationBellProps, DropdownMenuCheckboxItem, DropdownMenuContent, DropdownMenuItem, DropdownMenuLabel, DropdownMenuRadioItem (+15 more)
...
- **Why does `dependencies` connect `dependencies` to `devDependencies`, `cn`, `cmdk`, `framer-motion`, `html2canvas`, `class-variance-authority`, `next-themes`, `qrcode.react`, `@radix-ui/react-accordion`, `@radix-ui/react-alert-dialog`, `@radix-ui/react-avatar`, `@radix-ui/react-collapsible`, `@radix-ui/react-context-menu`, `@radix-ui/react-dialog`, `@radix-ui/react-dropdown-menu`, `@radix-ui/react-hover-card`, `@radix-ui/react-label`, `@radix-ui/react-navigation-menu`, `@radix-ui/react-popover`, `@radix-ui/react-progress`, `@radix-ui/react-radio-group`, `@radix-ui/react-scroll-area`, `@radix-ui/react-select`, `@radix-ui/react-slider`, `@radix-ui/react-slot`, `@radix-ui/react-switch`, `@radix-ui/react-toggle-group`, `react-day-picker`, `react-dom`, `react-router-dom`, `sonner`, `@supabase/supabase-js`, `tailwind-merge`, `tailwindcss-animate`, `@tanstack/react-query`, `vaul`, `zod`, `kernel`, `List`, `Loggable`, `Module`, `OrderTrackerDrawer.tsx`?**
  _High betweenness centrality (0.221) - this node is a cross-community bridge._
- **Why does `useToast()` connect `TableManagement.tsx` to `MenuManagement.tsx`, `cn`, `useToast`, `database.ts`, `hooks/use-toast.ts`, `class-variance-authority`?**
  _High betweenness centrality (0.202) - this node is a cross-community bridge._
- **Why does `react` connect `cn` to `TableManagement.tsx`, `dependencies`?**
...
- **Should `MenuManagement.tsx` be split into smaller, more focused modules?**
  _Cohesion score 0.10844748858447488 - nodes in this community are weakly interconnected._
