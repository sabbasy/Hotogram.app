# Graph Report - hotogram.app  (2026-07-27)

## Corpus Check
- 136 files · ~70,921 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 709 nodes · 1460 edges · 88 communities (40 shown, 48 thin omitted)
...
## Communities (88 total, 48 thin omitted)

### Community 0 - "MenuManagement.tsx"
Cohesion: 0.12
Nodes (39): Props, DashboardLayout(), DashboardLayoutProps, Logo(), LogoProps, Notification, Button, Card (+31 more)
...
Cohesion: 0.12
Nodes (20): PaymentTransactionsPanel(), NavLink, NavLinkCompatProps, Checkbox, DialogFooter(), OrderStatusBadge(), OrderStatusBadgeProps, PaymentStatusIndicator() (+12 more)

### Community 4 - "database.ts"
Cohesion: 0.06
Nodes (41): CustomerHelpButton(), CustomerRequestButtons(), CustomerRequestButtonsProps, OrderTrackerDrawer(), OrderTrackerDrawerProps, statusSteps, ScrollArea, ScrollBar (+33 more)
...
### Community 6 - "App.tsx"
Cohesion: 0.07
Nodes (25): AdminAuth, AdminOrders, AdminRevenue, AdminSettings, AdminSubscribers, Analytics, BillingDashboard, ContactExport (+17 more)
...
Cohesion: 0.18
Nodes (11): NotificationBell(), NotificationBellProps, DropdownMenuCheckboxItem, DropdownMenuContent, DropdownMenuItem, DropdownMenuLabel, DropdownMenuRadioItem, DropdownMenuSeparator (+3 more)
...
Cohesion: 0.15
Nodes (13): class-variance-authority, dependencies, class-variance-authority, @radix-ui/react-aspect-ratio, @radix-ui/react-tabs, @radix-ui/react-toast, @radix-ui/react-tooltip, recharts (+5 more)
...
Cohesion: 0.21
Nodes (12): statusColors, CustomerHelpButtonProps, CustomerIdentityDialog(), CustomerIdentityDialogProps, customerSchema, DialogContent, DialogDescription, DialogHeader() (+4 more)

### Community 21 - "clsx"
Cohesion: 0.14
Nodes (20): Badge(), BadgeProps, badgeVariants, SelectContent, SelectItem, SelectLabel, SelectScrollDownButton, SelectScrollUpButton (+12 more)

### Community 25 - "lucide-react"
Cohesion: 0.07
Nodes (43): RequirePlatformAdmin(), Input, Label, labelVariants, useToast(), useAuth(), ExtractedCategory, ExtractedItem (+35 more)
...
- **Why does `dependencies` connect `dependencies` to `devDependencies`, `cn`, `cmdk`, `framer-motion`, `html2canvas`, `next-themes`, `qrcode.react`, `@radix-ui/react-accordion`, `@radix-ui/react-alert-dialog`, `@radix-ui/react-avatar`, `@radix-ui/react-collapsible`, `@radix-ui/react-context-menu`, `@radix-ui/react-dialog`, `@radix-ui/react-dropdown-menu`, `@radix-ui/react-hover-card`, `@radix-ui/react-label`, `@radix-ui/react-navigation-menu`, `@radix-ui/react-popover`, `@radix-ui/react-progress`, `@radix-ui/react-radio-group`, `@radix-ui/react-scroll-area`, `@radix-ui/react-select`, `@radix-ui/react-slider`, `@radix-ui/react-slot`, `@radix-ui/react-switch`, `@radix-ui/react-toggle-group`, `react-day-picker`, `react-dom`, `react-router-dom`, `sonner`, `@supabase/supabase-js`, `tailwind-merge`, `tailwindcss-animate`, `@tanstack/react-query`, `vaul`, `zod`, `kernel`, `List`, `Loggable`, `Module`, `lucide-react`, `OrderTrackerDrawer.tsx`?**
  _High betweenness centrality (0.223) - this node is a cross-community bridge._
- **Why does `useToast()` connect `lucide-react` to `MenuManagement.tsx`, `cn`, `useToast`, `database.ts`, `hooks/use-toast.ts`, `sonner.tsx`, `class-variance-authority`, `clsx`?**
