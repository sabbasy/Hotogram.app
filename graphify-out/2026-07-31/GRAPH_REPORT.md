# Graph Report - hotogram.app  (2026-07-31)

## Corpus Check
- 141 files · ~74,549 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 727 nodes · 1508 edges · 86 communities (37 shown, 49 thin omitted)
...
Cohesion: 0.08
Nodes (64): RequirePlatformAdmin(), Props, DashboardLayout(), DashboardLayoutProps, Logo(), LogoProps, Badge(), BadgeProps (+56 more)
...
Cohesion: 0.11
Nodes (28): OrderTrackerDrawerProps, TabsContent, TabsList, TabsTrigger, getAudioContext(), playChimeSound(), useNotifications(), TableWithSession (+20 more)

### Community 4 - "database.ts"
Cohesion: 0.05
Nodes (64): statusColors, CustomerHelpButton(), CustomerHelpButtonProps, CustomerIdentityDialog(), CustomerIdentityDialogProps, customerSchema, HotogramLoader(), HotogramLoaderProps (+56 more)
...
Cohesion: 0.07
Nodes (40): PaymentTransactionsPanel(), CustomerRequestButtons(), CustomerRequestButtonsProps, Toast, ToastAction, ToastActionElement, ToastClose, ToastDescription (+32 more)
...
Cohesion: 0.10
Nodes (25): Notification, NotificationBell(), NotificationBellProps, AlertDialogAction, AlertDialogCancel, AlertDialogContent, AlertDialogDescription, AlertDialogFooter() (+17 more)
...
- **Why does `useToast()` connect `hooks/use-toast.ts` to `MenuManagement.tsx`, `cn`, `useToast`, `database.ts`, `class-variance-authority`?**
...
- **Should `MenuManagement.tsx` be split into smaller, more focused modules?**
  _Cohesion score 0.08030199039121483 - nodes in this community are weakly interconnected._
